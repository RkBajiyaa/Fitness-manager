...
export const MOVEMENT_DRAWINGS: MovementDrawing[] = [
  /* ============ horizontal push ============ */
  {
    ...
    frames: [
      { label: 'Setup', pose: SUPINE },
      { label: 'Lower', pose: pose(SUPINE, { upperArm: 10, foreArm: -100 }), holdMs: 900 },
      { label: 'Press', pose: SUPINE, holdMs: 700 },
    ],
  },
  {
    key: 'press_incline', name: 'Incline press', scene: 'incline_bench', prop: 'dumbbell',
    frames: [
      { label: 'Setup', pose: RECLINED },
      { label: 'Lower', pose: pose(RECLINED, { upperArm: -5, foreArm: -110 }), holdMs: 900 },
      { label: 'Press', pose: RECLINED, holdMs: 700 },
    ],
  },
  {
    ...
    frames: [
      ...
      { label: 'Open', pose: pose(SUPINE, { upperArm: -25, foreArm: -55 }), holdMs: 900 },
      { label: 'Squeeze', pose: pose(SUPINE, { upperArm: -85, foreArm: -80 }), holdMs: 700 },
    ],
  },
  {
  ...
  {
    key: 'dip', name: 'Dip', scene: 'rack', prop: 'none',
    frames: [
      { label: 'Top', pose: pose(STANDING, { hip: [50, 52], spine: -100, upperArm: 92, foreArm: 90, thigh: 70, shin: 40, foot: -20 }) },
      { label: 'Lower', pose: pose(STANDING, { hip: [50, 64], spine: -104, upperArm: 130, foreArm: 60, thigh: 70, shin: 40, foot: -20 }), holdMs: 900 },
  ...
  /* ============ vertical push ============ */
  {
    ...
    frames: [
      { label: 'Rack', pose: pose(STANDING, { upperArm: -50, foreArm: -105 }) },
      { label: 'Press', pose: pose(STANDING, { upperArm: -72, foreArm: -80 }), holdMs: 900 },
      { label: 'Lower', pose: pose(STANDING, { upperArm: -50, foreArm: -105 }), holdMs: 700 },
    ],
  },
  {
    key: 'raise_lateral', name: 'Lateral raise', scene: 'floor', prop: 'dumbbell',
    frames: [
      { label: 'Start', pose: pose(STANDING, { upperArm: 82, foreArm: 86 }) },
      { label: 'Raise', pose: pose(STANDING, { upperArm: 2, foreArm: 8 }), holdMs: 900 },
  ...
  /* ============ vertical pull ============ */
  {
    key: 'pulldown', name: 'Pulldown', scene: 'seat', prop: 'machine_handle',
    frames: [
      { label: 'Reach', pose: pose(SEATED, { spine: -84, upperArm: -80, foreArm: -86 }) },
      { label: 'Pull', pose: pose(SEATED, { spine: -80, upperArm: -20, foreArm: -120 }), holdMs: 900 },
  ...
  },
  {
    ...
    frames: [
      { label: 'Hang', pose: HANGING },
      { label: 'Pull', pose: pose(HANGING, { hip: [50, 52], upperArm: -55, foreArm: -125 }), holdMs: 900 },
  ...
  /* ============ horizontal pull ============ */
  {
    key: 'row_seated', name: 'Seated row', scene: 'seat', prop: 'cable',
    frames: [
      { label: 'Reach', pose: pose(SEATED, { spine: -78, upperArm: 6, foreArm: 2 }) },
      { label: 'Pull', pose: pose(SEATED, { spine: -92, upperArm: 40, foreArm: 175 }), holdMs: 900 },
  ...
  },
  {
    ...
    frames: [
      { label: 'Hinge', pose: pose(STANDING, { hip: [52, 60], spine: -140, thigh: 80, shin: 92, upperArm: 84, foreArm: 88 }) },
      { label: 'Pull', pose: pose(STANDING, { hip: [52, 60], spine: -140, thigh: 80, shin: 92, upperArm: 130, foreArm: 30 }), holdMs: 900 },
  ...
  },
  {
    ...
    frames: [
      ...
      { label: 'Pull', pose: pose(STANDING, { upperArm: -5, foreArm: -155 }), holdMs: 900 },
  ...
  /* ============ squat ============ */
  {
    ...
    frames: [
      { label: 'Stand', pose: pose(STANDING, { upperArm: -140, foreArm: -35 }) },
      {
        label: 'Descend',
        pose: pose(STANDING, { hip: [48, 72], spine: -105, thigh: 25, shin: 108, foot: 0, upperArm: -140, foreArm: -35 }),
        holdMs: 900,
      },
      { label: 'Drive', pose: pose(STANDING, { upperArm: -140, foreArm: -35 }), holdMs: 700 },
    ],
  },
  {
  ...
  {
    key: 'lunge', name: 'Lunge', scene: 'floor', prop: 'dumbbell',
    frames: [
  ...
  },
  {
    ...
    frames: [
      ...
      { label: 'Raise', pose: pose(STANDING, { hip: [50, 50], foot: -58 }), holdMs: 900 },
  ...
  /* ============ hinge ============ */
  {
    ...
    frames: [
      { label: 'Set', pose: pose(STANDING, { hip: [52, 68], spine: -125, thigh: 55, shin: 100, upperArm: 82, foreArm: 88 }) },
      { label: 'Pull', pose: pose(STANDING, { upperArm: 82, foreArm: 88 }), holdMs: 900 },
  ...
  },
  {
    ...
    frames: [
      ...
      { label: 'Hinge', pose: pose(STANDING, { hip: [54, 58], spine: -150, thigh: 84, shin: 95, upperArm: 84, foreArm: 88 }), holdMs: 900 },
  ...
  {
    key: 'leg_curl', name: 'Leg curl', scene: 'seat', prop: 'machine_handle',
    frames: [
      { label: 'Start', pose: { hip: [54, 74], spine: 184, neck: 184, upperArm: 80, foreArm: 90, thigh: 0, shin: 0, foot: -20 } },
      { label: 'Curl', pose: { hip: [54, 74], spine: 184, neck: 184, upperArm: 80, foreArm: 90, thigh: 0, shin: -95, foot: -110 }, holdMs: 900 },
      { label: 'Return', pose: { hip: [54, 74], spine: 184, neck: 184, upperArm: 80, foreArm: 90, thigh: 0, shin: 0, foot: -20 }, holdMs: 700 },
    ],
  },
  {
    key: 'leg_extension', name: 'Leg extension', scene: 'seat', prop: 'machine_handle',
    frames: [
      { label: 'Start', pose: pose(SEATED, { thigh: -2, shin: 86, foot: -30 }) },
      { label: 'Extend', pose: pose(SEATED, { thigh: -2, shin: -4, foot: -40 }), holdMs: 900 },
  ...
  /* ============ arms ============ */
  {
    ...
    frames: [
      ...
      { label: 'Curl', pose: pose(STANDING, { upperArm: 84, foreArm: -40 }), holdMs: 900 },
  ...
  },
  {
    ...
    frames: [
      ...
      { label: 'Extend', pose: pose(STANDING, { upperArm: 84, foreArm: 88 }), holdMs: 900 },
      { label: 'Return', pose: pose(STANDING, { upperArm: 84, foreArm: -50 }), holdMs: 700 },
    ],
  },
  {
    key: 'extension_overhead', name: 'Overhead extension', scene: 'floor', prop: 'dumbbell',
    frames: [
      { label: 'Start', pose: pose(STANDING, { upperArm: -72, foreArm: -78 }) },
      { label: 'Lower', pose: pose(STANDING, { upperArm: -72, foreArm: 150 }), holdMs: 900 },
  ...
  /* ============ core ============ */
  {
    ...
    frames: [
      { label: 'Brace', pose: PRONE, holdMs: 1500 },
  ...
  },
  {
    ...
    frames: [
      ...
      { label: 'Raise', pose: pose(HANGING, { thigh: 2, shin: 4, foot: -30 }), holdMs: 900 },
      { label: 'Lower', pose: pose(HANGING, { thigh: 88, shin: 86, foot: -20 }), holdMs: 700 },
    ],
  },
  {
    key: 'rotation', name: 'Rotation', scene: 'cable_tower', prop: 'cable',
    frames: [
      { label: 'Load', pose: pose(STANDING, { spine: -100, upperArm: -60, foreArm: -55 }) },
      { label: 'Rotate', pose: pose(STANDING, { spine: -78, upperArm: 45, foreArm: 50 }), holdMs: 900 },
  ...
  /* ============ cardio & gait ============ */
  {
    key: 'run', name: 'Run', scene: 'treadmill', prop: 'none',
    frames: [
  ...
  {
    key: 'walk', name: 'Walk', scene: 'treadmill', prop: 'none',
    frames: [
  ...
  {
    key: 'cycle', name: 'Cycle', scene: 'bike', prop: 'none',
    frames: [
  ...
  {
    key: 'row_erg', name: 'Row', scene: 'rower', prop: 'machine_handle',
    frames: [
  ...
  {
    key: 'stair', name: 'Stair climb', scene: 'floor', prop: 'none',
    frames: [
  ...
  /* ============ mobility & warm-up ============ */
  {
    key: 'stretch_hip', name: 'Hip flexor stretch', scene: 'floor', prop: 'none',
    frames: [
      { label: 'Kneel', pose: { hip: [50, 66], spine: -92, neck: -92, upperArm: 84, foreArm: 88, thigh: 40, shin: 100, foot: 0 }, holdMs: 1400 },
      { label: 'Press hips', pose: { hip: [54, 68], spine: -80, neck: -80, upperArm: 84, foreArm: 88, thigh: 30, shin: 110, foot: 0 }, holdMs: 1400 },
    ],
  },
  {
    ...
    key: 'rotation_thoracic', name: 'Thoracic rotation', scene: 'floor', prop: 'none',
    frames: [
      {
        label: 'Set',
  ...
  {
    key: 'foam_roll', name: 'Foam roll', scene: 'floor', prop: 'none',
    frames: [
  ...
  {
    key: 'leg_swing', name: 'Leg swing', scene: 'floor', prop: 'none',
    frames: [
  ...
  },
  {
    ...
    frames: [
      ...
      { label: 'Sit back', pose: pose(STANDING, { hip: [48, 72], spine: -105, thigh: 25, shin: 108, foot: 0, upperArm: 8, foreArm: 2 }), holdMs: 900 },
