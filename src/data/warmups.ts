...
export const WARMUP_EXERCISES: ExerciseContent[] = [
  {
    ...
    focus: 'Easy enough to hold a conversation. This is not the workout.',
  ...
  },
  {
    ...
    focus: 'Light resistance, quick legs. You should finish warm, not tired.',
  ...
  },
  {
    ...
    focus: 'Small circles first, then bigger. Never force the range.',
  ...
  },
  {
    ...
    focus: 'Elbow stays pinned to your side — only the forearm turns.',
  ...
  },
  {
    ...
    focus: 'Squeeze the shoulder blades together, not the hands apart.',
  ...
  },
  {
    ...
    focus: 'Hold something. Let the leg swing loose rather than kicking it.',
  ...
  },
  {
    ...
    focus: 'Slow and full depth. You are teaching the pattern, not training it.',
  ...
  },
  {
    ...
    focus: 'Move one vertebra at a time. Breathe with it.',
  ...
  },
  {
    ...
    focus: 'Pull the shoulders down away from the ears without bending the elbows.',
  ...
  },
  {
    ...
    focus: 'Same movement, light weight. Build to your working load, never to failure.',
