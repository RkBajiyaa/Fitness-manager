...
export const CARDIO_EXERCISES: ExerciseContent[] = [
  {
    ...
    focus: 'Land under your hips with a quick, quiet step.',
  ...
  },
  {
    ...
    focus: 'Walk tall and let go of the handrails — leaning on them removes the work.',
  ...
  },
  {
    ...
    focus: 'Brisk enough to breathe harder but still talk.',
  ...
  },
  {
    ...
    focus: 'Set the seat so your knee is almost straight at the bottom.',
  ...
  },
  {
    ...
    focus: 'Push and pull with the arms too — it is a whole-body machine.',
  ...
  },
  {
    ...
    focus: 'Legs, then back, then arms. Reverse that on the way in.',
  ...
  },
  {
    ...
    focus: 'Stand upright and push through the whole foot.',
  ...
  },
  {
    ...
    focus: 'Whole foot on the step, upright posture, hands off the rails.',
  ...
  },
  {
    ...
    focus: 'Tiny hops off the balls of the feet. Wrists turn the rope, not the arms.',
